...
CREATE INDEX IF NOT EXISTS productos_codigo_trgm_idx ON productos USING GIN (codigo gin_trgm_ops);
CREATE INDEX IF NOT EXISTS productos_marca_trgm_idx ON productos USING GIN (marca gin_trgm_ops);
CREATE INDEX IF NOT EXISTS productos_descripcion_trgm_idx ON productos USING GIN (descripcion gin_trgm_ops);
CREATE INDEX IF NOT EXISTS productos_codigo_barras_trgm_idx ON productos USING GIN ("codigoBarras" gin_trgm_ops);
